...
For the radial directions it is necessary to take a slightly different approach. Indeed, Earnshaw's theorem \cite{EarnshawOnTN} states
...
\begin{equation}
    ...
    \label{eq:Mathieu}.
\end{equation}
\Cref{eq:Mathieu} is known as the Mathieu equation \cite{Abramowitz_1972}, the Mathieu equation has bounded solutions for several sets of $(a,q_\gamma)$ parameters,
